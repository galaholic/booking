...
export default function TabletPage() {
  ...
  return (
    <RoleGate
      ...
      title="Geschaeftslogin erforderlich"
      description="Das Tablet-Dashboard ist nur fuer Geschaefte sichtbar."
      ctaHref="/business/login"
      ctaLabel="Zum Geschaeftslogin"
    >
              ...
              >
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <h3 className="mt-2 text-lg font-display">
                      {booking.customer}
                    </h3>
